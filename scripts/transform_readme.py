...
def main(target: str) -> None:
    ...
    for existing, replacement in [
        (
            "https://img.shields.io/pypi/v/sparv-sbx-corpus-statistics.svg",
            f"https://img.shields.io/pypi/v/sparv-sbx-corpus-statistics/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/l/sparv-sbx-corpus-statistics.svg",
            f"https://img.shields.io/pypi/l/sparv-sbx-corpus-statistics/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/pyversions/sparv-sbx-corpus-statistics.svg",
            f"https://img.shields.io/pypi/pyversions/sparv-sbx-corpus-statistics/{version}.svg",
        ),
        (
            "https://img.shields.io/pypi/status/sparv-sbx-corpus-statistics.svg",
            f"https://img.shields.io/pypi/status/sparv-sbx-corpus-statistics/{version}.svg",
        ),
    ]:
    ...
    def replace(match: re.Match) -> str:
        ...
        if not url.startswith("http"):
            url = urllib.parse.urljoin(
                f"https://github.com/spraakbanken/sparv-sbx-corpus-statistics/blob/{version}/README.md",
                url,
            )
        return f"]({url})"
